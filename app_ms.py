# by Misbah Syed
# github.com/menloparklab/langchain-cohere-qdrant-retrieval
...
def embed_pdf():
    ...
    qdrant = Qdrant.from_documents(docs, embeddings, url=qdrant_url,
...
def retrieve_info():
    ...
    chain = load_qa_chain(
        OpenAI(openai_api_key=openai_api_key, temperature=0.2), chain_type="stuff")
